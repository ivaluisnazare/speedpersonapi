...
### Neste estudo, aproveitei de um projeto apresentado em curso sobre boas práticas, *Desenvolvendo um sistema de gerenciamento de pessoas em API REST com Spring Boot/DIO*, e acrescentei o método delete todos os elementos cadastrados no banco h2, correções na classe, `@service`, que contém o método PUT e em outras passagens do código, a exemplo, na que se refere a utilização do mapstruct.
